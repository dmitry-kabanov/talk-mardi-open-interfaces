...
\end{column}
\end{columns}
\footnotetext[1]{Rosenbrock, H.H. (1960). "An automatic method for finding the greatest or least value of a function"}
\end{frame}

\begin{frame}[fragile]{Example 1: Julia user calls \textsc{Ipopt.jl}}
  \begin{columns}
    \begin{column}{\dimexpr0.7\textwidth - 2\tabcolsep}
