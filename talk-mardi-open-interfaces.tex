...
\documentclass[
  ...
  aspectratio=169,
  english,
  onlytextwidth,  % Compute widths ignoring padding
]{beamer}
\usetheme[
...
% -----------------------------------------------------------------------------
\section{Example with the interface for initial-value problems for ODEs (time integration)}

\begin{frame}[fragile]{Example: Solving a stiff system}
  \begin{columns}[t]
    \column{0.4\textwidth}
