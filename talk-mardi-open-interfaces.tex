...
% -----------------------------------------------------------------------------
% Title info
\title{MaRDI Open Interfaces for Scientific Computing}
\author{Dmitry I.\ Kabanov, Stephan Rave, Mario Ohlberger}
\institute{Mathematics Münster, University of Münster, Germany}
\date{Kickoff Meeting of the GAMM RSE-RDM Activity Group, 4 December 2025}
...
\begin{frame}
  ...
  \begin{minipage}{0.618\textwidth}
    \begin{itemize}
      ...
      \item Paper: \url{https://doi.org/10.5334/jors.569}
    \end{itemize}
  \end{minipage}%
